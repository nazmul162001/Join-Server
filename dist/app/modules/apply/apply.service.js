...
const createApplication = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { candidateId } = data,
      applicationData = __rest(data, ['candidateId']);
    // Verify if candidate exists, if candidateId is provided
    if (candidateId) {
      const candidateExists =
        yield prisma_1.default.candidateProfile.findUnique({
    ...
    const application = yield prisma_1.default.applyJob.create({
      // @ts-ignore
      data: Object.assign(Object.assign({}, applicationData), {
